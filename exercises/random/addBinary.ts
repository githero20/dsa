...
//   let res = [];
//   // using this instead of string because strings are immutable, and any modification will result
...
//   while (i >= 0 || j >= 0) {
//     // we're looping from rtl
//     let sum: number = carry;
//     // we're adding any carry from the last addition
//     if (j >= 0) {
//       // sum += b.charAt(j--)
//     }
//   }
